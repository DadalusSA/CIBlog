	...
	class Posts extends CI_Controller{
		...
		public function create()
		{
			...
			else
			{
				...
				$this->session->set_flashdata('post_created', 'You have posted a status');
				redirect('posts');
		...
		public function delete($id)
		{
			...
			$this->session->set_flashdata('post_deleted', 'Deleted post');
		...
		public function update()
		{
			...
			$this->session->set_flashdata('post_updated', 'Updated post');
